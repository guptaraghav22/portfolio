...
export const Bio = {
  ...
  "I am a versatile freelancer specializing in web development, API integrations, and database management. With a focus on clean code, performance optimization, and scalable solutions, I bring expertise in technologies like JavaScript, Node.js,React js, Angular and MongoDB. I am committed to delivering efficient, high-quality solutions that align with project goals, ensuring seamless functionality and timely delivery.",
    github: "https://github.com/guptaraghav22",
  resume:
...
export const projects = [
  {
    ...
    category: "web app",
    github: "https://github.com/guptaraghav22/cryto",
  ...
  },
  {
    ...
    description:
      "A full-stack food delivery application inspired by Swiggy, allowing users to search for restaurants, browse menus, place orders, and track deliveries in real-time. It also includes user authentication, reviews, and a restaurant management dashboard for vendors.",
    image: zomato,
    tags: [
      "React Js",
      "Node Js",
    ...
    category: "web app",
    github: "https://github.com/guptaraghav22/swiggy-clone",
